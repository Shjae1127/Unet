...
parser.add_argument(
    "--data_dir", default="Unet/reference/datasets", type=str, dest="data_dir")
parser.add_argument(
    "--ckpt_dir", default="Unet/reference/checkpoint", type=str, dest="ckpt_dir")
parser.add_argument(
    "--log_dir", default="Unet/reference/log", type=str, dest="log_dir")
parser.add_argument(
    "--result_dir", default="Unet/reference/result", type=str, dest="result_dir")
